        ...
        result.sort((a, b) => {
            ...
            switch (sortBy) {
                ...
                case "reporter_desc":
                    ...
                    break;
                case "reported_asc":
                    comparison = a.reportedUsername.localeCompare(
                        b.reportedUsername,
                        "pl",
                        { sensitivity: "base" }
                    );
                    break;
                case "reported_desc":
                    comparison = b.reportedUsername.localeCompare(
                        a.reportedUsername,
                        "pl",
                        { sensitivity: "base" }
                    );
            ...
            <div className="flex items-center gap-2 mb-4 justify-end">
                <div className="relative">
                    ...
                    >
                        ...
                        <option value="reported_asc">
                            Zgłoszony użytkownik A-Z
                        </option>
                        <option value="reported_desc">
                            Zgłoszony użytkownik Z-A
                        </option>

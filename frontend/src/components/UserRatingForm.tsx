...
export default function UserRatingForm({ onSubmit, disabled }: Props) {
  ...
  return (
    <div className="bg-zinc-900/60 rounded-2xl p-5 ring-1 ring-zinc-800 space-y-3">
      <h3 className="text-white font-semibold mb-3 text-lg">Oceń użytkownika</h3>
